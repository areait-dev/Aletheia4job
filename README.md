...
A full-featured, production-ready job tracking application built with Next.js 14+, TypeScript, Clerk, Prisma, React Query, PostgreSQL, and modern web technologies. Job Aletheia helps job seekers efficiently organize, track, and analyze their job search journey with a beautiful, responsive dashboard.
