...
// per lo stesso pattern): senza questo, metadataBase - e quindi ogni
// canonical/og:url/og:image relativo generato dall'app - punterebbe a
// un dominio sbagliato in produzione.
